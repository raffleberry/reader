  ...
  <nav class="navbar navbar-themed border-bottom sticky-top">
    <div class="container">
      ...
      <div class="d-flex align-items-center gap-3">
        <RouterLink to="/" class="nav-link px-0">Library</RouterLink>
        <button class="nav-link px-0 border-0 bg-transparent" @click="car.show('settings')">
          Settings
        </button>
        <select
          ...
          :value="reader.theme"
          title="Theme"
          @change="reader.setTheme(($event.target as HTMLSelectElement).value as ThemeName)"
        >
